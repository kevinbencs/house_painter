...
${pageOfImg.join('\n')}
- [Árak](https://${process.env.URL}/arak): A szolgáltatások (festés, tapétázás, stb.) árai vannak itt feltűntetve.
- [Kapcsolat](https://${process.env.URL}/kapcsolat): Kapcsolatfelvételi lehetőségekről lehet itt olvasni.
